...
/*~ class.phpmailer.php
.---------------------------------------------------------------------------.
|  Softgoods: PHPMailer - PHP email class                                    |
|   Version: 2.1                                                            |
|   Contact: via sourceforge.net support pages (also www.codeworxtech.com)  |
|      Info: http://phpmailer.sourceforge.net                               |
|   Support: http://sourceforge.net/projects/phpmailer/                     |
|   Description: http://php.russofile.ru/ru/translate/mail/phpmailer        |
| ------------------------------------------------------------------------- |
...
class Mail_PHPMailer
{
   ...
   * @return bool
   */
  function SetLanguage($lang_type = 'ru', $lang_path = 'language')
  {
    $path = dirname(__FILE__) . '/' . $lang_path . '/' . 'phpmailer.lang-' . $lang_type . '.php';
    if ( !file_exists($path) )
    {
